...
<head>
	<meta charset="UTF-8">
	<title>Test de sexualidad</title>
</head>
<body>
	<header>
...
<nav>
  ...
  <div class="nav-wrapper">
	...
	<a href="#" class="sidenav-trigger" data-target="mobile-nav" >
     ...
     <ul class="right hide-on-med-and-down">
       ...
       <li><a href="cuestionario_sexualidad.php" class="red">Test sexualidad</a></li>
 ...
 <table>
      ...
      $sql= "SELECT *FROM pregunta WHERE id>20 AND id<=30 ";
...
<form method="POST" align="justify" name="test3" action="p_sexualidad.php">

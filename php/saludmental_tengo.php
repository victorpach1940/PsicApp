...
<html lang="es">
  ...
  <body>
    ...
    <nav id="menu" class="navbar navbar-toggleable-md navbar-inverse bg-primary fixed-top">
      ...
      <a class="navbar-brand" href="#" ><h3>Test salud mental</h3></a>
...
<div class="banner" class="img-fluid" alt="Responsive image">
  ...
  <center>
  <section><br><br><br><br><br><br></br></br></br></br></br><strong><p style="font-size:90px; color:white; font-family: 'Courgette', cursive;">¿Padece algun problema mental?</p></strong>
  </section>
</center>
</div>
 ...
 <div class="box container white
  ...
  <script>
    ...
    var preguntas = [                                     // Pregunta Respuesta
        ['¿Tiene usted sentimientos de tristeza o desánimo?', 'si'],         //  [0][0]   [0][1]
    ...
    function muestraResultado(){
      ...
      switch(acertadas){
        ...
        case 3:
          ...
          break;
        case 4:
          resultado = 'Alto indice de riesgo parece ser que padeces una profunda depresión, comunicate con uno de nuestros expertos, te atenderemos con mucho gusto, en PsicApp tu eres la persona mas importante.';
          break;
        case 5:
          resultado = '¡Por favor comunicate con nosotros, queremos ayudarte, tu eres la razón de que PsicApp exista.';
          break;
      }

  ...
  <div class="nav-wrapper">
	...
	<a href="#" class="sidenav-trigger" data-target="mobile-nav" >
     ...
     <ul class="right hide-on-med-and-down">
       ...
       <li><a href="sexualidad.php" class="red">Sexualidad</a></li>
...
<?php }elseif ($menu==2) { ?>
	<nav>
	  ...
	  <div class="nav-wrapper">
		...
		<a href="#" class="sidenav-trigger" data-target="mobile-nav" >
	     ...
	     <ul class="right hide-on-med-and-down">
				 <li><a href="cuestionario_sexualidad.php">¿Sexualidad?</a></li>
	       <li><a href="adicciones.php" >Adicciones</a></li>
	       <li><a href="saludmental.php">Salud mental</a></li>
	       <li><a href="sexualidad.php" class="red">Sexualidad</a></li>
	       <li><a href="violenciadepareja.php">Violencia de pareja</a></li>
	...
	<?php } ?>
  <section>
		<br><br><br><br><br><br><br><strong><p style="font-size:90px; font-family: 'Courgette', cursive;">Sexualidad</p></strong>
  </section>
  ...
  <h1>Sexualidad</h1>
			...
			<ol class="indice-lista">
				...
				<img class="responsive-img" src="../img/se2.jpg" width="5000"></br>
				...
				<img class="responsive-img" src="../img/se1.jpg" width="5000"></br>
				...
				<img class="responsive-img" src="../img/se3.jpg" width="5000"></br>
				...
				<img class="responsive-img" src="../img/se10.jpg" width="5000"></br>
				...
				Casi todos los chicos están convencidos de que las chicas tienen los mismos impulsos sexuales que ellos. Pero eso no es así. El hombre se predispone sexualmente con más facilidad y reacciona más a estímulos visuales. Sus sentimientos en la actividad sexual no le tocan tan a fondo ni dejan tanta huella como en la mujer. La predisposición de las mujeres es más profunda y ellas reaccionan más lentamente a los estímulos sexuales. Hay más implicación psíquica en la vida sexual en la mujer que en el hombre. Por todo ello el conocimiento mutuo, el trato, la fidelidad, la lealtad, la continencia, y la aceptación de los compromisos que conlleva el amor, son parte muy importante para una unión sexual satisfactoria para el hombre y la mujer.</br>
								<img class="responsive-img" src="../img/sexo.jpg" width="5000"></br>
				...
				<img class="responsive-img" src="../img/se11.jpg" width="5000"></br>
				...
				<img class="responsive-img" src="../img/sexualidad.jpg"width="5000"></br>
				...
				<img class="responsive-img" src="../img/se4.jpg" width="5000"></br>
				<b>VIH</b>
				...
				<img class="responsive-img" src="../img/se5.jpg" width="5000"></br>
				...
				<b><h3 id="17">Preguntas frecuentes</b></h3>
				...
				<b>13. ¿POR QUÉ INCLINAMOS LA CABEZA HACIA LA DERECHA AL BESARNOS?</b></br>
				Los fetos y los recién nacidos ya tienden a dormir con el cuello inclinado hacia la derecha. Y el 80% de las madres acunan a sus bebés en su brazo izquierdo, lo cual deja libre la mejilla derecha para besos y caricias. De ahí en adelante, lo habitual será que asociemos ese lado con el cariño.</br>
				<b>14. ¿POR QUÉ SENTIMOS MARIPOSAS EN EL ESTÓMAGO?</b></br>
				Según algunos estudios, el responsable es nuestro 'segundo cerebro'. Científicos norteamericanos han demostrado que los 100 millones de células que rodean el tracto digestivo funcionan como una especie de cerebro secundario abdominal, dedicado a controlar gran número de reacciones de nuestro cuerpo en correspondencia con los procesos psíquicos. Sus informaciones influyen por medio de una serie de transmisiones nerviosas sobre las decisiones que toma el cerebro 'pensante'.</br>

				Según confirman estoes estudios, los sentimientos y las intuiciones suben 'de las tripas', junto con otras muchas señales procedentes del vientre, como las náuseas, el vómito y el dolor. En el cerebro, la memoria emotiva recoge y almacena todas esas informaciones viscerales. Por ejemplo, las sensaciones desagradables suscitadas por una situación de peligro (como el dolor de barriga que sentimos ante un examen inminente cuando no hemos estudiado), como el cosquilleo que provoca la cercanía del sujeto deseado o la revolución que se nos desata en las tripas cuando se nos acerca un sujeto que no queremos tratar.</br>

				Todas las ocasiones en que nos vemos en una situación que ya hemos vivido antes, los sentimientos y nuestra conducta quedan determinados por los datos inconscientes que se extraen del gigantesco catálogo de la emotividad. En ese banco de memoria, la sensacion de tener mariposas en el epigastrio se vincula con el enamoramiento o 'flechazo'.</br>
				<b>15. ¿PUEDE UNA MUJER ALCANZAR EL ORGASMO CON SOLO TOCARLE LOS PECHOS?</b></br>
				No solamente es posible, sino que es medianamente frecuente. La Fundación Kinsey, la más prestigiosa del mundo en cuanto a investigación sexológica, realizó un estudio en el que revelaba que el 12% de las mujeres llegaba al orgasmo “empujando y amasando” sus pechos (ellas mismas o su compañero).</br>

				Pero lo más efectivo, con diferencia, es la succión de los pezones: el mismo estudio cifró en 57 el porcentaje de féminas que alcanzaba el clímax mediante esta práctica. Los senos son el principal atractivo para los hombres, seguidos de los glúteos.</br>
				<b>16. ¿PIERDEN SENSIBILIDAD LAS MUJERES DESPUÉS DE HABER SIDO MADRES?</b></br>
				No necesariamente. Si acaso, en la zona inferior, si es que han tenido que hacerles una episiotomía (una pequeña “ampliación” de la vagina para agrandar el canal de parto). Y casi siempre esta insensibilidad se ciñe a la pequeña cicatriz que queda.</br>

				El clítoris, desde luego, no queda afectado de ninguna manera y sigue estando en perfecta forma para el disfrute del sexo. Lo que es sabido que ocurre es que la secreción de prolactina que acompaña al parto (para generar leche materna) reduce la libido, pero solo durante el período que dura la lactancia. Es la llamada cuarentena.</br>
				<b>17. ¿CUÁL ES EL MEJOR DÍA PARA EL SEXO?</b></br>
				...
				¿La clave?: Tenemos un reloj interno de unas 24 horas. Este, está dentro de nuestro sistema en un nivel celular. Incluso las algas tienen un sistema similar interno, según una investigación de las Universidades de Cambridge y Edimburgo.</br>

				Es decir, que si "configuras" tu reloj biológico un poquito más temprano las mañanas de los jueves, cuando los niveles de testosterona y estrógeno son casi cinco veces más altos que en otros momentos, ten por seguro que saldrás de casa un poco más feliz que otros días.</br>
				<b>18. ¿Qué son las fantasías sexuales?</b></br>
				Las fantasías sexuales son deseos de experimentar el sexo de maneras no tradicionales. Es algo que por lo general no es tema de conversación.</br></br>

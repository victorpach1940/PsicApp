...
<html lang="es">
  ...
  <body>
    ...
    <nav id="menu" class="navbar navbar-toggleable-md navbar-inverse bg-primary fixed-top">
      ...
      <a class="navbar-brand" href="#" ><h4>Detectar adicción</h4></a>
...
<div class="banner" class="img-fluid" alt="Responsive image">
  ...
  <center>
  <section><br><br><br><br><br><br></br></br></br></br></br><strong><p style="font-size:70px; color:white; font-family: 'Courgette', cursive;">¿Como detectar una adicción en un ser querido?</p></strong>
  </section>
</center>
</div>
  ...
  <p id="resolucion"></p> </br>
   ...
   <div class="constainer-fluid">
        ...
        <div class="col-md-12">
          ...
          <a href="../html/adicciones.html"><button type="button" class="btn btn-lg btn-outline-primary">Adicciones</button></a>
    ...
    function muestraResultado(){
      ...
      switch(acertadas){
        ...
        case 3:
          ...
          break;
        case 4:
          resultado = 'Detectamos un indice alto de riesgo en cuanto adicciones se refiere, visita la sección de adicciones y comunicate con uno de nuestros expertos';
          break;
        case 5:
          resultado = '¡Indice de riesgo elevado, es necesario comunicarte con uno de nuestros expertos';
          break;
      }

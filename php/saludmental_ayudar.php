...
<html lang="es">
  ...
  <body>
    ...
    <nav id="menu" class="navbar navbar-toggleable-md navbar-inverse bg-primary fixed-top">
      ...
      <a class="navbar-brand" href="#" ><h4>La salud mental</h4></a>
...
<div class="banner" class="img-fluid" alt="Responsive image">
  ...
  <center>
  <section><br><br><br><br><br><br></br></br></br></br></br><strong><p style="font-size:70px; color:white; font-family: 'Courgette', cursive;">¿Problema mental?</p></strong>
  </section>
</center>
</div>
  ...
  <p id="resolucion"></p> </br>
   ...
   <div class="constainer-fluid">
        ...
        <div class="col-md-12">
          ...
          <a href="../html/saludmental.html"><button type="button" class="btn btn-lg btn-outline-primary">Salud Mental</button></a>

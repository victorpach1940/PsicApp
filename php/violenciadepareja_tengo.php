     ...
     <div class="box container white
      ...
      <script>
        ...
        var preguntas = [                                     // Pregunta Respuesta
            ['¿A notado cambios en su propia manera de vestir?', 'si'],         //  [0][0]   [0][1]
            ['¿A notado que presenta síntomas depresivos y de ansiedad ?.', 'si'],                              //  [1][0]   [1][1]
            ['¿Tiene miedo de llagar a casa, o de cometer un error delante de su pareja?.', 'si'],                //  [2][0]   [2][1]
            ['¿Le an comentado que muestra un estado de ánimo triste?.', 'si'],                 // ...
            ['¿En su forma de vestir siente pena de que la gente la mire y por lo tanto tapa partes de su cuerpo como brazos, rostro, escote o se maquilla excesivamente?', 'si']       // [9][0] y [9][1]
          ],
          pregunta, respuesta,
          formuladas = 0,
          acertadas = 0;

...
<html lang="es">
  ...
  <body>
    ...
    <nav id="menu" class="navbar navbar-toggleable-md navbar-inverse bg-primary fixed-top">
      ...
      <a class="navbar-brand" href="#" ><h4 style="color:white;">Categorias</h4></a>
...
<div class="banner" class="img-fluid" alt="Responsive image">
  <center>
  <section><br><br><br><br><br><br></br></br></br></br></br><strong><p style="font-size:70px; color:white; font-family: 'Courgette', cursive;">Elige una categoría</p></strong>
  </section>
</center>
</div>

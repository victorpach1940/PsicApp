...
//saber estado de donde mas hay visitas
$sql4=''; $sql5=''; $restado=''; $myarray= array(); $minum=0;$EDO=''; $nuevoarray=''; $edomayor='';
$sql4="SELECT distinct(estado) FROM VISITANTES ORDER BY estado;";
$restado=mysqli_query($conn, $sql4);
while ($estate = mysqli_fetch_assoc($restado)) {
	$EDO=$estate['estado'];
	$sql5="SELECT estado FROM VISITANTES WHERE estado='".$EDO."';";
	$rcuentes=mysqli_query($conn, $sql5);
	$minum=mysqli_num_rows($rcuentes);
	$myarray[]=$minum;
}
asort($myarray);
$nuevoarray=array_pop($myarray);
...
<div id="about" class="container text-center  text-white" style="background:url(../img/background.jpg) no-repeat center center fixed; display: table; height: 90%; position: relative; width: 100%; background-size: cover; width:100%; height:550px; padding: 60px 25px; ">
  <div class="row-sm-12">
  ...
  <p style="font-size: 25px;">¡No estas solo!</p>
	...
	<p>Region de <?php print ($edomayor); ?>: <span class="badge badge-primary" style="background-color: #008080;"><?php print $nuevoarray; ?></span></p>
...
<div class="container-fluid">
	<div class="row text-center">
		<img src="../img/anuncio.gif" style="height:80px;">
		<img src="../img/anuncio.gif" style="height:80px;">
		<img src="../img/anuncio.gif" style="height:80px;">
	</div>
</div>

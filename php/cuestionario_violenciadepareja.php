...
<head>
	<meta charset="UTF-8">
	<title>Test de Violencia de pareja</title>
</head>
<body>
	<header>
...
<nav>
  ...
  <div class="nav-wrapper">
	...
	<a href="#" class="sidenav-trigger" data-target="mobile-nav" >
     ...
     <ul class="right hide-on-med-and-down">
       ...
       <li><a href="cuestionario_violenciadepareja.php"class="red">Test violencia de pareja</a></li>
  ...
  <h1>Test de violencia de pareja</h1>
			<p >
 ...
 <table>
      ...
      $sql= "SELECT *FROM pregunta WHERE id>30 AND id<=40 ";

<!DOCTYPE html>
      <html lang="es">
        ...
        <body>
          ...
          <nav id="menu" class="navbar navbar-toggleable-md navbar-inverse bg-primary fixed-top">
            ...
            <a class="navbar-brand" href="#" ><h3>La salud sexual</h3></a>
      ...
      <div class="banner" class="img-fluid" alt="Responsive image">
        ...
        <center>
        <section><br><br><br><br><br><br></br></br></br></br></br><strong><p style="font-size:90px; color:white; font-family: 'Courgette', cursive;">¿Tiene un problema de salud sexual?</p></strong>
        </section>
      </center>
      </div>

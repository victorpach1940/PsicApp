		...
		<article style="background-color:gray;">
			...
			<ol class="indice-lista">
				...
				<li><a href="#8">Preguntas frecuentes</a></li>
					...
					<ul>
					<li><a href="#">¿Si una persona pide ayuda por dónde empieza?</a> </li>
					<li><a href="#"></a>¿Que deberíamos buscar en un centro de tratamiento de adicciones</li>
					<li><a href="#"></a>Me harán dejar de consumir drogas inmediatamente?</li>
					<li><a href="#"></a>¿La drogadicción es tratada por un médico? </li>
					<li><a href="#"></a>¿Qué tipo de consejería existe?</li>
					<li><a href="#"></a>¿Existen medicamentos que pueden ayudar?</li>
					<li><a href="#"></a>¿Qué ocurre cuando una persona ha estado en rehabilitación anteriormente?</li>
					<li><a href="#"></a>¿Y si una persona está preocupada que otros lo descubran?</li>
					<li><a href="#"></a>¿Qué sucede si una persona consume drogas porque se siente deprimida y detener su consumo empeore las cosas?</li>
					<li><a href="#"></a>¿Cómo una persona puede hablar con otras con problemas similares?</li>
					<li><a href="#"></a>Las personas dicen que no deberíamos consumir drogas y conducir, pero ¿qué pasa si se siente bien mientras conduce?</li>
					<li><a href="#"></a>¿Dónde puedo encontrar información sobre drogas específicas?</li>
				</li>
				</ul>
			-->
			</ul>
